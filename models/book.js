...
class Book {
  ...
  static async create(data) {
    //i have to validate in models and in middleware/routes? Taking forever to learn since none of this was taught.
    const validation = jsonschema.validate(data, bookSchema);
    if (!validation.valid) {
